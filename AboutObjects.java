...
public class AboutObjects {
	...
	public void objectToString() {
		...
		String expectedToString = MessageFormat.format("{0}@{1}", Object.class
				.getName(), Integer.toHexString(object.hashCode()));
		assertEquals(expectedToString, object.toString()); // hint:
															// object.toString()
	}
